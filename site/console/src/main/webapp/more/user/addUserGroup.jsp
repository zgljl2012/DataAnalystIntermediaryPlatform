...
<html lang="zh">
  <head>
    ...
    <title>添加管理员组-<%=variableManage.getValue(SystemVariable.SITENAME) %></title>
  ...
  <body>
    ...
    <div class="panel panel-default">
    	<div class="panel-heading">添加管理员组</div>
    	<div class="panel-body">
    	<div id="container">
    		<form action="user/addUserGroup" method="post">
				<div class="row">
					<div class="col-sm-9">
						<span><input type="text" name="name" placeholder="请输入用户组名" required></span>
					</div>
				</div>
				<div class="row mt10">
					<div class="col-sm-3">
