...
/**
 * @author 廖金龙
 * @version 2016年5月5日下午11:31:16
 * 中标Servlet
 */
@SuppressWarnings("serial")
@WebServlet(name="projectBidSelect", urlPatterns={"/project/bid/select"})
public class ProjectBidSelectServlet extends AbstractServlet{
