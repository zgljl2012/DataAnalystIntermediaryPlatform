...
/**
 *@author 廖金龙
 *@version 2016年2月28日上午1:19:43
 */
@SuppressWarnings("serial")
@WebServlet(urlPatterns={"/verifyCode"}, name="VerifyCode")
public class VerifyCodeServlet extends AbstractServlet{
	...
	protected void get(HttpServletRequest request, HttpServletResponse response,
        ...
        //7.将随机数存在session中
        VerifyCodeValidate.validTime = 60*1000; // 设定验证码过时时间
        VerifyCode vc = new VerifyCode(random);
        request.getSession().setAttribute("verifyCode", vc);
