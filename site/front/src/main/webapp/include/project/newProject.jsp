...
<div class="container">
	<form action="" onsubmit="return onNewProject(this);">
	<div class="row mt20 tc">
		...
		<div class="col-sm-2 tc">
			<input style="width:100%;" class="m-input-form-control" name="projectName" type="text" placeholder="字数大于4少于20" maxlength=20 onblur="checkProjectName(this)">
		...
		<div class="col-sm-3">
			<input style="width:80%;" class="fl m-input-form-control" name="willPrice" type="text" placeholder="可选面议" maxlength=10 onblur="checkWillPrice(this);">
	...
	<div class="row mt20 tc">
		...
		<div class="col-sm-2 tc">
			<input style="width:100%;" class="m-input-form-control" name="bidDays" type="text" placeholder="请输入招标天数" maxlength=10 onblur="checkBidDays(this)">
			<span error class="display_none red fl"></span>
		</div>
		<div class="col-sm-2 tc">
		...
		<div class="col-sm-3">
			...
			maxlength=10 onblur="checkTimeLimit(this)"
			onchange="checkTimeLimit(this)"
			>
			<span error class="display_none red fl"></span>
		</div>
		<div class="col-sm-2"></div>
	...
	<div class="row tc mt10">
		<div class="col-sm-12 tc">
		    ...
		    <textarea name="projectDescription" class="mt10" placeholder="请输入项目描述（不少于10字，少于500字）" 
		    	...
		    	onblur="checkProjectDescription(this)"
		   ></textarea><br>
...
<script src="/front/publics/js/user/project/newProject.js"></script>